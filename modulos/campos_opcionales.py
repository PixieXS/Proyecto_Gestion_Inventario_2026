"""
campos_opcionales.py — Gestión de campos opcionales de productos.

El admin activa/desactiva campos desde Administración → Campos de Producto.
Los campos activos aparecen en: formulario, tabla, exportación Excel y PDF.
...
CAMPOS DISPONIBLES:
  ...
  color           — Color
  peso            — Peso (kg/g)
  ubicacion       — Ubicación en bodega (ej. A-12, Estante 3)
  numero_serie    — Número de serie
  garantia_meses  — Garantía en meses
  fecha_vence     — Fecha de vencimiento
  impuesto_pct    — ITBIS / Impuesto %
"""
